...
CallbackReturn
GazeboOdriSimSystem::on_init(const hardware_interface::HardwareInfo & actuator_info)
{
...
CallbackReturn GazeboOdriSimSystem::on_activate(const rclcpp_lifecycle::State & previous_state)
{
  return CallbackReturn::SUCCESS;
  return hardware_interface::SystemInterface::on_activate(previous_state);
}

CallbackReturn GazeboOdriSimSystem::on_deactivate(const rclcpp_lifecycle::State & previous_state)
{
  return CallbackReturn::SUCCESS;
